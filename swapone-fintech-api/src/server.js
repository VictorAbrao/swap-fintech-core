...
const clientQuotationRoutes = require('./routes/client/quotation');
const clientExecuteFxTradeRoutes = require('./routes/client/execute-fx-trade');
...
app.use('/api/client/quotation', clientQuotationRoutes);
app.use('/api/client/execute-fx-trade', clientExecuteFxTradeRoutes);
